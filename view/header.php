...
<html>
    <head>
        ...
        <meta name="description" content="<?=$fullname?> Wallet">
        <meta name="author" content="<?=$fullname?> Wallet">
        
        <!-- Bootstrap include stuff -->
        <link href="//netdna.bootstrapcdn.com/font-awesome/4.4.0/css/font-awesome.css" rel="stylesheet">
        <link href="<?=$server_url?>assets/css/bootstrap.min.css" rel="stylesheet">
        <link href="<?=$server_url?>assets/css/wallet.css" rel="stylesheet">
		<link href="<?=$server_url?>assets/css/languages.min.css" rel="stylesheet">

<script  src="https://code.jquery.com/jquery-3.5.1.min.js"  integrity="sha256-9/aliU8dGd2tb6OSsuzixeV4y/faTqgFtohetphbbj0="
  crossorigin="anonymous"></script>
        <script src="//cdnjs.cloudflare.com/ajax/libs/moment.js/2.6.0/moment.min.js"></script>
        <script src="assets/js/bootstrap.min.js"></script>
     <script src="assets/js/jquery.frydBox.min.js"></script>
    
        <!-- End Bootstrap include stuff-->
        <title><?=$fullname?> Wallet</title>
      
<link rel="shortcut icon" type="image/x-icon" href="<?=$server_url?>assets/css/md-ico.png" />
<link rel="apple-touch-icon" href="<?=$server_url?>assets/css/md-ico.png" />
